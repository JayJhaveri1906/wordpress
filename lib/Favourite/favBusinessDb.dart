...
final favTableBusiness = 'favBusiness';

class FavBusinessDatabaseProvider {
//Constructor
  static final FavBusinessDatabaseProvider dbProvider =
      FavBusinessDatabaseProvider();
...
//Creating the Database
  void initDB(Database database, int version) async {
    ...
    await database.execute(
        'CREATE TABLE $favTableBusiness (id INTEGER PRIMARY KEY, title TEXT, content TEXT, image TEXT, video TEXT, author TEXT, avatar TEXT, category TEXT, date TEXT, link TEXT, catId INTEGER)');
  }
}
